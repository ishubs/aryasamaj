        ...
        <Box sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="Instant Marriage Certificate"
              description="Instant Marriage Certificate: Couples Now Eligible to Receive Certificate on the Same Day of Arya Samaj Wedding Ceremony"
            />
